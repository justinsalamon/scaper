...
def generate_from_jams(jams_infile, audio_outfile):
    '''
    ...
    fg_path = ann.sandbox.scaper['fg_path']
    bg_path = ann.sandbox.scaper['bg_path']
    protected_labels = ann.sandbox.scaper['protected_labels']

    sc = Scaper(duration, fg_path, bg_path, protected_labels)
